...
`ble_protocol.py` and `ble_worker.py` are distributed under GPL-3.0-or-later. Their complete Python source is included in this directory and the container. The license is in `licenses/GPL-3.0.txt`.
